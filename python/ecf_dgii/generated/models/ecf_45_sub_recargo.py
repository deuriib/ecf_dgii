...
T = TypeVar("T", bound="Ecf45SubRecargo")
...
class Ecf45SubRecargo:
    """
    Attributes:
        tipo_sub_recargo (Ecf45TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_recargo = Ecf45TipoDescuentoRecargoType(d.pop("tipoSubRecargo"))
