...
T = TypeVar("T", bound="Ecf34SubRecargo")


@_attrs_define
class Ecf34SubRecargo:
    """
    Attributes:
        tipo_sub_recargo (Ecf34TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_recargo = Ecf34TipoDescuentoRecargoType(d.pop("tipoSubRecargo"))
