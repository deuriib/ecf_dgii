...
from ..models.ecf_32_tipo_ajuste_type import Ecf32TipoAjusteType
...
T = TypeVar("T", bound="Ecf32DescuentoORecargo")
...
class Ecf32DescuentoORecargo:
    ...
    Attributes:
        ...
        tipo_ajuste (Ecf32TipoAjusteType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tipo_ajuste = Ecf32TipoAjusteType(d.pop("tipoAjuste"))
        ...
        ecf_32_descuento_o_recargo = cls(
        ...
        ecf_32_descuento_o_recargo.additional_properties = d
        return ecf_32_descuento_o_recargo
