...
T = TypeVar("T", bound="Ecf43OtraMonedaDetalle")
...
class Ecf43OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_43_otra_moneda_detalle = cls(
        ...
        ecf_43_otra_moneda_detalle.additional_properties = d
        return ecf_43_otra_moneda_detalle
