...
T = TypeVar("T", bound="Ecf33SubRecargo")
...
class Ecf33SubRecargo:
    """
    Attributes:
        tipo_sub_recargo (Ecf33TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_recargo = Ecf33TipoDescuentoRecargoType(d.pop("tipoSubRecargo"))
