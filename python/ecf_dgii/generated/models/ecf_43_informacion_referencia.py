...
T = TypeVar("T", bound="Ecf43InformacionReferencia")
...
class Ecf43InformacionReferencia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_43_informacion_referencia = cls(
        ...
        ecf_43_informacion_referencia.additional_properties = d
        return ecf_43_informacion_referencia
