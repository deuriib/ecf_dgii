...
T = TypeVar("T", bound="Ecf32SubtotalImpuestoAdicional")
...
class Ecf32SubtotalImpuestoAdicional:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_32_subtotal_impuesto_adicional = cls(
        ...
        ecf_32_subtotal_impuesto_adicional.additional_properties = d
        return ecf_32_subtotal_impuesto_adicional
