...
T = TypeVar("T", bound="Ecf47InformacionReferencia")
...
class Ecf47InformacionReferencia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_47_informacion_referencia = cls(
        ...
        ecf_47_informacion_referencia.additional_properties = d
        return ecf_47_informacion_referencia
