...
T = TypeVar("T", bound="Ecf31SubtotalImpuestoAdicional")


@_attrs_define
class Ecf31SubtotalImpuestoAdicional:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_31_subtotal_impuesto_adicional = cls(
        ...
        ecf_31_subtotal_impuesto_adicional.additional_properties = d
        return ecf_31_subtotal_impuesto_adicional
