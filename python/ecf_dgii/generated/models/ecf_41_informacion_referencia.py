...
T = TypeVar("T", bound="Ecf41InformacionReferencia")
...
class Ecf41InformacionReferencia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_41_informacion_referencia = cls(
        ...
        ecf_41_informacion_referencia.additional_properties = d
        return ecf_41_informacion_referencia
