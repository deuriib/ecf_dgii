...
T = TypeVar("T", bound="Ecf33OtraMonedaDetalle")
...
class Ecf33OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_33_otra_moneda_detalle = cls(
        ...
        ecf_33_otra_moneda_detalle.additional_properties = d
        return ecf_33_otra_moneda_detalle
