...
from ..models.ecf_45_indicador_bieno_servicio_type import Ecf45IndicadorBienoServicioType
from ..models.ecf_45_indicador_facturacion_type import Ecf45IndicadorFacturacionType
from ..models.unidad_medida_type_type_1 import UnidadMedidaTypeType1
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ecf_45_codigos_item import Ecf45CodigosItem
    from ..models.ecf_45_impuesto_adicional import Ecf45ImpuestoAdicional
    from ..models.ecf_45_otra_moneda_detalle import Ecf45OtraMonedaDetalle
    from ..models.ecf_45_sub_descuento import Ecf45SubDescuento
    from ..models.ecf_45_sub_recargo import Ecf45SubRecargo
    from ..models.ecf_45_subcantidad_item import Ecf45SubcantidadItem


T = TypeVar("T", bound="Ecf45Item")
...
class Ecf45Item:
    ...
    Attributes:
        ...
        indicador_facturacion (Ecf45IndicadorFacturacionType):
        nombre_item (str):
        indicador_bieno_servicio (Ecf45IndicadorBienoServicioType):
        cantidad_item (float | str):
        precio_unitario_item (float | str):
        monto_item (float | str):
        tabla_codigos_item (list[Ecf45CodigosItem] | None | Unset):
        ...
        tabla_subcantidad (list[Ecf45SubcantidadItem] | None | Unset):
        ...
        tabla_sub_descuento (list[Ecf45SubDescuento] | None | Unset):
        recargo_monto (float | None | str | Unset):
        tabla_sub_recargo (list[Ecf45SubRecargo] | None | Unset):
        tabla_impuesto_adicional (list[Ecf45ImpuestoAdicional] | None | Unset):
        otra_moneda_detalle (Ecf45OtraMonedaDetalle | None | Unset):
    """
    ...
    precio_unitario_item: float | str
    monto_item: float | str
    tabla_codigos_item: list[Ecf45CodigosItem] | None | Unset = UNSET
    ...
    tabla_subcantidad: list[Ecf45SubcantidadItem] | None | Unset = UNSET
    ...
    tabla_sub_descuento: list[Ecf45SubDescuento] | None | Unset = UNSET
    recargo_monto: float | None | str | Unset = UNSET
    tabla_sub_recargo: list[Ecf45SubRecargo] | None | Unset = UNSET
    tabla_impuesto_adicional: list[Ecf45ImpuestoAdicional] | None | Unset = UNSET
    otra_moneda_detalle: Ecf45OtraMonedaDetalle | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.otra_moneda_detalle, Ecf45OtraMonedaDetalle):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        indicador_facturacion = Ecf45IndicadorFacturacionType(d.pop("indicadorFacturacion"))

        nombre_item = d.pop("nombreItem")

        indicador_bieno_servicio = Ecf45IndicadorBienoServicioType(d.pop("indicadorBienoServicio"))
        ...
        def _parse_tabla_codigos_item(data: object) -> list[Ecf45CodigosItem] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tabla_codigos_item_type_1_item_data in _tabla_codigos_item_type_1:
                    tabla_codigos_item_type_1_item = Ecf45CodigosItem.from_dict(tabla_codigos_item_type_1_item_data)
                ...
                pass
            return cast(list[Ecf45CodigosItem] | None | Unset, data)
        ...
        def _parse_tabla_subcantidad(data: object) -> list[Ecf45SubcantidadItem] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_subcantidad_type_1_item_data in _tabla_subcantidad_type_1:
                    tabla_subcantidad_type_1_item = Ecf45SubcantidadItem.from_dict(tabla_subcantidad_type_1_item_data)
                ...
                pass
            return cast(list[Ecf45SubcantidadItem] | None | Unset, data)
        ...
        def _parse_tabla_sub_descuento(data: object) -> list[Ecf45SubDescuento] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_sub_descuento_type_1_item_data in _tabla_sub_descuento_type_1:
                    tabla_sub_descuento_type_1_item = Ecf45SubDescuento.from_dict(tabla_sub_descuento_type_1_item_data)
                ...
                pass
            return cast(list[Ecf45SubDescuento] | None | Unset, data)
        ...
        def _parse_tabla_sub_recargo(data: object) -> list[Ecf45SubRecargo] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_sub_recargo_type_1_item_data in _tabla_sub_recargo_type_1:
                    tabla_sub_recargo_type_1_item = Ecf45SubRecargo.from_dict(tabla_sub_recargo_type_1_item_data)
                ...
                pass
            return cast(list[Ecf45SubRecargo] | None | Unset, data)

        tabla_sub_recargo = _parse_tabla_sub_recargo(d.pop("tablaSubRecargo", UNSET))

        def _parse_tabla_impuesto_adicional(data: object) -> list[Ecf45ImpuestoAdicional] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_impuesto_adicional_type_1_item_data in _tabla_impuesto_adicional_type_1:
                    tabla_impuesto_adicional_type_1_item = Ecf45ImpuestoAdicional.from_dict(
                ...
                pass
            return cast(list[Ecf45ImpuestoAdicional] | None | Unset, data)

        tabla_impuesto_adicional = _parse_tabla_impuesto_adicional(d.pop("tablaImpuestoAdicional", UNSET))

        def _parse_otra_moneda_detalle(data: object) -> Ecf45OtraMonedaDetalle | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                otra_moneda_detalle_type_1 = Ecf45OtraMonedaDetalle.from_dict(data)

                return otra_moneda_detalle_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf45OtraMonedaDetalle | None | Unset, data)
        ...
        ecf_45_item.additional_properties = d
        return ecf_45_item
