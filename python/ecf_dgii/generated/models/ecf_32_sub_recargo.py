...
T = TypeVar("T", bound="Ecf32SubRecargo")
...
class Ecf32SubRecargo:
    """
    Attributes:
        tipo_sub_recargo (Ecf32TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_recargo = Ecf32TipoDescuentoRecargoType(d.pop("tipoSubRecargo"))
