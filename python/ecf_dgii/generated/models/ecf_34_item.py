...
from ..models.ecf_34_indicador_bieno_servicio_type import Ecf34IndicadorBienoServicioType
from ..models.ecf_34_indicador_facturacion_type import Ecf34IndicadorFacturacionType
from ..models.unidad_medida_type_type_1 import UnidadMedidaTypeType1
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.ecf_34_codigos_item import Ecf34CodigosItem
    from ..models.ecf_34_impuesto_adicional import Ecf34ImpuestoAdicional
    from ..models.ecf_34_mineria import Ecf34Mineria
    from ..models.ecf_34_otra_moneda_detalle import Ecf34OtraMonedaDetalle
    from ..models.ecf_34_retencion import Ecf34Retencion
    from ..models.ecf_34_sub_descuento import Ecf34SubDescuento
    from ..models.ecf_34_sub_recargo import Ecf34SubRecargo
    from ..models.ecf_34_subcantidad_item import Ecf34SubcantidadItem


T = TypeVar("T", bound="Ecf34Item")
...
class Ecf34Item:
    ...
    Attributes:
        ...
        indicador_facturacion (Ecf34IndicadorFacturacionType):
        nombre_item (str):
        indicador_bieno_servicio (Ecf34IndicadorBienoServicioType):
        cantidad_item (float | str):
        precio_unitario_item (float | str):
        monto_item (float | str):
        tabla_codigos_item (list[Ecf34CodigosItem] | None | Unset):
        retencion (Ecf34Retencion | None | Unset):
        ...
        tabla_subcantidad (list[Ecf34SubcantidadItem] | None | Unset):
        ...
        mineria (Ecf34Mineria | None | Unset):
        descuento_monto (float | None | str | Unset):
        tabla_sub_descuento (list[Ecf34SubDescuento] | None | Unset):
        recargo_monto (float | None | str | Unset):
        tabla_sub_recargo (list[Ecf34SubRecargo] | None | Unset):
        tabla_impuesto_adicional (list[Ecf34ImpuestoAdicional] | None | Unset):
        otra_moneda_detalle (Ecf34OtraMonedaDetalle | None | Unset):
    """
    ...
    precio_unitario_item: float | str
    monto_item: float | str
    tabla_codigos_item: list[Ecf34CodigosItem] | None | Unset = UNSET
    retencion: Ecf34Retencion | None | Unset = UNSET
    ...
    tabla_subcantidad: list[Ecf34SubcantidadItem] | None | Unset = UNSET
    ...
    mineria: Ecf34Mineria | None | Unset = UNSET
    descuento_monto: float | None | str | Unset = UNSET
    tabla_sub_descuento: list[Ecf34SubDescuento] | None | Unset = UNSET
    recargo_monto: float | None | str | Unset = UNSET
    tabla_sub_recargo: list[Ecf34SubRecargo] | None | Unset = UNSET
    tabla_impuesto_adicional: list[Ecf34ImpuestoAdicional] | None | Unset = UNSET
    otra_moneda_detalle: Ecf34OtraMonedaDetalle | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        retencion: dict[str, Any] | None | Unset
        if isinstance(self.retencion, Unset):
            retencion = UNSET
        elif isinstance(self.retencion, Ecf34Retencion):
        ...
        if isinstance(self.mineria, Unset):
            mineria = UNSET
        elif isinstance(self.mineria, Ecf34Mineria):
        ...
        elif isinstance(self.otra_moneda_detalle, Ecf34OtraMonedaDetalle):
        ...
        if retencion is not UNSET:
            field_dict["retencion"] = retencion
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        indicador_facturacion = Ecf34IndicadorFacturacionType(d.pop("indicadorFacturacion"))

        nombre_item = d.pop("nombreItem")

        indicador_bieno_servicio = Ecf34IndicadorBienoServicioType(d.pop("indicadorBienoServicio"))
        ...
        def _parse_tabla_codigos_item(data: object) -> list[Ecf34CodigosItem] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tabla_codigos_item_type_1_item_data in _tabla_codigos_item_type_1:
                    tabla_codigos_item_type_1_item = Ecf34CodigosItem.from_dict(tabla_codigos_item_type_1_item_data)
                ...
                pass
            return cast(list[Ecf34CodigosItem] | None | Unset, data)

        tabla_codigos_item = _parse_tabla_codigos_item(d.pop("tablaCodigosItem", UNSET))

        def _parse_retencion(data: object) -> Ecf34Retencion | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                retencion_type_1 = Ecf34Retencion.from_dict(data)

                return retencion_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf34Retencion | None | Unset, data)

        retencion = _parse_retencion(d.pop("retencion", UNSET))
        ...
        def _parse_tabla_subcantidad(data: object) -> list[Ecf34SubcantidadItem] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_subcantidad_type_1_item_data in _tabla_subcantidad_type_1:
                    tabla_subcantidad_type_1_item = Ecf34SubcantidadItem.from_dict(tabla_subcantidad_type_1_item_data)

                    tabla_subcantidad_type_1.append(tabla_subcantidad_type_1_item)

                return tabla_subcantidad_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(list[Ecf34SubcantidadItem] | None | Unset, data)
        ...
        def _parse_mineria(data: object) -> Ecf34Mineria | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                mineria_type_1 = Ecf34Mineria.from_dict(data)

                return mineria_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf34Mineria | None | Unset, data)
        ...
        def _parse_tabla_sub_descuento(data: object) -> list[Ecf34SubDescuento] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_sub_descuento_type_1_item_data in _tabla_sub_descuento_type_1:
                    tabla_sub_descuento_type_1_item = Ecf34SubDescuento.from_dict(tabla_sub_descuento_type_1_item_data)
                ...
                pass
            return cast(list[Ecf34SubDescuento] | None | Unset, data)
        ...
        def _parse_tabla_sub_recargo(data: object) -> list[Ecf34SubRecargo] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_sub_recargo_type_1_item_data in _tabla_sub_recargo_type_1:
                    tabla_sub_recargo_type_1_item = Ecf34SubRecargo.from_dict(tabla_sub_recargo_type_1_item_data)
                ...
                pass
            return cast(list[Ecf34SubRecargo] | None | Unset, data)

        tabla_sub_recargo = _parse_tabla_sub_recargo(d.pop("tablaSubRecargo", UNSET))

        def _parse_tabla_impuesto_adicional(data: object) -> list[Ecf34ImpuestoAdicional] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_impuesto_adicional_type_1_item_data in _tabla_impuesto_adicional_type_1:
                    tabla_impuesto_adicional_type_1_item = Ecf34ImpuestoAdicional.from_dict(
                ...
                pass
            return cast(list[Ecf34ImpuestoAdicional] | None | Unset, data)

        tabla_impuesto_adicional = _parse_tabla_impuesto_adicional(d.pop("tablaImpuestoAdicional", UNSET))

        def _parse_otra_moneda_detalle(data: object) -> Ecf34OtraMonedaDetalle | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                otra_moneda_detalle_type_1 = Ecf34OtraMonedaDetalle.from_dict(data)

                return otra_moneda_detalle_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf34OtraMonedaDetalle | None | Unset, data)
        ...
        ecf_34_item.additional_properties = d
        return ecf_34_item
