...
T = TypeVar("T", bound="Ecf46OtraMonedaDetalle")
...
class Ecf46OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_46_otra_moneda_detalle = cls(
        ...
        ecf_46_otra_moneda_detalle.additional_properties = d
        return ecf_46_otra_moneda_detalle
