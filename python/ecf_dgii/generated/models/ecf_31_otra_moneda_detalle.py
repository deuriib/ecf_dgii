...
T = TypeVar("T", bound="Ecf31OtraMonedaDetalle")
...
class Ecf31OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_31_otra_moneda_detalle = cls(
        ...
        ecf_31_otra_moneda_detalle.additional_properties = d
        return ecf_31_otra_moneda_detalle
