...
if TYPE_CHECKING:
    from ..models.acecf_reception_request_dto import AcecfReceptionRequestDto


T = TypeVar("T", bound="PaginatedApiResultOfAcecfReceptionRequestDto")
...
class PaginatedApiResultOfAcecfReceptionRequestDto:
    ...
    next_page_uri: None | str
    values: list[AcecfReceptionRequestDto] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = AcecfReceptionRequestDto.from_dict(values_item_data)
        ...
        paginated_api_result_of_acecf_reception_request_dto = cls(
        ...
        paginated_api_result_of_acecf_reception_request_dto.additional_properties = d
        return paginated_api_result_of_acecf_reception_request_dto
