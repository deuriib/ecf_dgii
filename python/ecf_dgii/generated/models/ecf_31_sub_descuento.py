...
T = TypeVar("T", bound="Ecf31SubDescuento")
...
class Ecf31SubDescuento:
    """
    Attributes:
        tipo_sub_descuento (Ecf31TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_descuento = Ecf31TipoDescuentoRecargoType(d.pop("tipoSubDescuento"))
        ...
        ecf_31_sub_descuento.additional_properties = d
        return ecf_31_sub_descuento
