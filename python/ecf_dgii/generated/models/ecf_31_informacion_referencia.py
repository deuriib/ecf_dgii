...
T = TypeVar("T", bound="Ecf31InformacionReferencia")
...
class Ecf31InformacionReferencia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_31_informacion_referencia = cls(
        ...
        ecf_31_informacion_referencia.additional_properties = d
        return ecf_31_informacion_referencia
