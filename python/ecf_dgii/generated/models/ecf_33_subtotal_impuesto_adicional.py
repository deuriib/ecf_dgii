...
T = TypeVar("T", bound="Ecf33SubtotalImpuestoAdicional")


@_attrs_define
class Ecf33SubtotalImpuestoAdicional:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_33_subtotal_impuesto_adicional = cls(
        ...
        ecf_33_subtotal_impuesto_adicional.additional_properties = d
        return ecf_33_subtotal_impuesto_adicional
