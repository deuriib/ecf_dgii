...
T = TypeVar("T", bound="Ecf33ImpuestoAdicional2")
...
class Ecf33ImpuestoAdicional2:
    """
    Attributes:
        tipo_impuesto (Ecf33CodificacionTipoImpuestosType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_impuesto = Ecf33CodificacionTipoImpuestosType(d.pop("tipoImpuesto"))
        ...
        ecf_33_impuesto_adicional_2 = cls(
        ...
        ecf_33_impuesto_adicional_2.additional_properties = d
        return ecf_33_impuesto_adicional_2
