...
if TYPE_CHECKING:
    from ..models.ecf_34_impuesto_adicional_otra_moneda import Ecf34ImpuestoAdicionalOtraMoneda


T = TypeVar("T", bound="Ecf34OtraMoneda")
...
class Ecf34OtraMoneda:
    ...
    Attributes:
        ...
        impuestos_adicionales_otra_moneda (list[Ecf34ImpuestoAdicionalOtraMoneda] | None | Unset):
    ...
    impuestos_adicionales_otra_moneda: list[Ecf34ImpuestoAdicionalOtraMoneda] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_impuestos_adicionales_otra_moneda(
            data: object,
        ) -> list[Ecf34ImpuestoAdicionalOtraMoneda] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for impuestos_adicionales_otra_moneda_type_1_item_data in _impuestos_adicionales_otra_moneda_type_1:
                    impuestos_adicionales_otra_moneda_type_1_item = Ecf34ImpuestoAdicionalOtraMoneda.from_dict(
                ...
                pass
            return cast(list[Ecf34ImpuestoAdicionalOtraMoneda] | None | Unset, data)
        ...
        ecf_34_otra_moneda.additional_properties = d
        return ecf_34_otra_moneda
