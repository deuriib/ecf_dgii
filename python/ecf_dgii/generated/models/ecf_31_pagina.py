...
if TYPE_CHECKING:
    from ..models.ecf_31_subtotal_impuesto_adicional import Ecf31SubtotalImpuestoAdicional


T = TypeVar("T", bound="Ecf31Pagina")
...
class Ecf31Pagina:
    ...
    Attributes:
        ...
        subtotal_impuesto_adicional (Ecf31SubtotalImpuestoAdicional | None | Unset):
    ...
    subtotal_impuesto_adicional: Ecf31SubtotalImpuestoAdicional | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.subtotal_impuesto_adicional, Ecf31SubtotalImpuestoAdicional):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subtotal_impuesto_adicional(data: object) -> Ecf31SubtotalImpuestoAdicional | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                subtotal_impuesto_adicional_type_1 = Ecf31SubtotalImpuestoAdicional.from_dict(data)

                return subtotal_impuesto_adicional_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf31SubtotalImpuestoAdicional | None | Unset, data)
        ...
        ecf_31_pagina.additional_properties = d
        return ecf_31_pagina
