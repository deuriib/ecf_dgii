...
if TYPE_CHECKING:
    from ..models.ecf_31_impuesto_adicional_2 import Ecf31ImpuestoAdicional2


T = TypeVar("T", bound="Ecf31Totales")
...
class Ecf31Totales:
    ...
    Attributes:
        ...
        impuestos_adicionales (list[Ecf31ImpuestoAdicional2] | None | Unset):
    ...
    impuestos_adicionales: list[Ecf31ImpuestoAdicional2] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_impuestos_adicionales(data: object) -> list[Ecf31ImpuestoAdicional2] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for impuestos_adicionales_type_1_item_data in _impuestos_adicionales_type_1:
                    impuestos_adicionales_type_1_item = Ecf31ImpuestoAdicional2.from_dict(
                ...
                pass
            return cast(list[Ecf31ImpuestoAdicional2] | None | Unset, data)
        ...
        ecf_31_totales.additional_properties = d
        return ecf_31_totales
