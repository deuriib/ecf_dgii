...
from ..models.ecf_46_tipo_ingresos_validation_type import Ecf46TipoIngresosValidationType
from ..models.ecf_46_tipo_pago_type import Ecf46TipoPagoType
...
if TYPE_CHECKING:
    from ..models.ecf_46_forma_de_pago import Ecf46FormaDePago


T = TypeVar("T", bound="Ecf46IdDoc")
...
class Ecf46IdDoc:
    ...
    Attributes:
        ...
        encf (str):
        tipo_ingresos (Ecf46TipoIngresosValidationType):
        tipo_pago (Ecf46TipoPagoType):
        ...
        tabla_formas_pago (list[Ecf46FormaDePago] | None | Unset):
    ...
    tabla_formas_pago: list[Ecf46FormaDePago] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tipo_ingresos = Ecf46TipoIngresosValidationType(d.pop("tipoIngresos"))

        tipo_pago = Ecf46TipoPagoType(d.pop("tipoPago"))
        ...
        def _parse_tabla_formas_pago(data: object) -> list[Ecf46FormaDePago] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        ecf_46_id_doc.additional_properties = d
        return ecf_46_id_doc
