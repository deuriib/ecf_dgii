...
T = TypeVar("T", bound="Ecf47OtraMonedaDetalle")


@_attrs_define
class Ecf47OtraMonedaDetalle:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_47_otra_moneda_detalle = cls(
        ...
        ecf_47_otra_moneda_detalle.additional_properties = d
        return ecf_47_otra_moneda_detalle
