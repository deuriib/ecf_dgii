...
T = TypeVar("T", bound="Ecf44OtraMonedaDetalle")
...
class Ecf44OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_44_otra_moneda_detalle = cls(
        ...
        ecf_44_otra_moneda_detalle.additional_properties = d
        return ecf_44_otra_moneda_detalle
