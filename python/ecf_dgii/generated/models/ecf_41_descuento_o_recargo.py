...
from ..models.ecf_41_tipo_ajuste_type import Ecf41TipoAjusteType
...
T = TypeVar("T", bound="Ecf41DescuentoORecargo")
...
class Ecf41DescuentoORecargo:
    ...
    Attributes:
        ...
        tipo_ajuste (Ecf41TipoAjusteType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tipo_ajuste = Ecf41TipoAjusteType(d.pop("tipoAjuste"))
        ...
        ecf_41_descuento_o_recargo = cls(
        ...
        ecf_41_descuento_o_recargo.additional_properties = d
        return ecf_41_descuento_o_recargo
