...
if TYPE_CHECKING:
    from ..models.anulacion_list_response import AnulacionListResponse


T = TypeVar("T", bound="PaginatedApiResultOfAnulacionListResponse")
...
class PaginatedApiResultOfAnulacionListResponse:
    ...
    next_page_uri: None | str
    values: list[AnulacionListResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = AnulacionListResponse.from_dict(values_item_data)
        ...
        paginated_api_result_of_anulacion_list_response = cls(
        ...
        paginated_api_result_of_anulacion_list_response.additional_properties = d
        return paginated_api_result_of_anulacion_list_response
