...
T = TypeVar("T", bound="Ecf44SubRecargo")
...
class Ecf44SubRecargo:
    """
    Attributes:
        tipo_sub_recargo (Ecf44TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_recargo = Ecf44TipoDescuentoRecargoType(d.pop("tipoSubRecargo"))
