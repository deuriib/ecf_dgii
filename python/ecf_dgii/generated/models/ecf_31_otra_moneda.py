...
if TYPE_CHECKING:
    from ..models.ecf_31_impuesto_adicional_otra_moneda import Ecf31ImpuestoAdicionalOtraMoneda


T = TypeVar("T", bound="Ecf31OtraMoneda")
...
class Ecf31OtraMoneda:
    ...
    Attributes:
        ...
        impuestos_adicionales_otra_moneda (list[Ecf31ImpuestoAdicionalOtraMoneda] | None | Unset):
    ...
    impuestos_adicionales_otra_moneda: list[Ecf31ImpuestoAdicionalOtraMoneda] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_impuestos_adicionales_otra_moneda(
            data: object,
        ) -> list[Ecf31ImpuestoAdicionalOtraMoneda] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for impuestos_adicionales_otra_moneda_type_1_item_data in _impuestos_adicionales_otra_moneda_type_1:
                    impuestos_adicionales_otra_moneda_type_1_item = Ecf31ImpuestoAdicionalOtraMoneda.from_dict(
                ...
                pass
            return cast(list[Ecf31ImpuestoAdicionalOtraMoneda] | None | Unset, data)
        ...
        ecf_31_otra_moneda.additional_properties = d
        return ecf_31_otra_moneda
