...
T = TypeVar("T", bound="Ecf32OtraMonedaDetalle")
...
class Ecf32OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_32_otra_moneda_detalle = cls(
        ...
        ecf_32_otra_moneda_detalle.additional_properties = d
        return ecf_32_otra_moneda_detalle
