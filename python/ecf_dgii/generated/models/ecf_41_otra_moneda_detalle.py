...
T = TypeVar("T", bound="Ecf41OtraMonedaDetalle")
...
class Ecf41OtraMonedaDetalle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_41_otra_moneda_detalle = cls(
        ...
        ecf_41_otra_moneda_detalle.additional_properties = d
        return ecf_41_otra_moneda_detalle
