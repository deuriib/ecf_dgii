...
T = TypeVar("T", bound="Ecf31ImpuestoAdicional")
...
class Ecf31ImpuestoAdicional:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_31_impuesto_adicional = cls(
            tipo_impuesto=tipo_impuesto,
        )

        ecf_31_impuesto_adicional.additional_properties = d
        return ecf_31_impuesto_adicional
