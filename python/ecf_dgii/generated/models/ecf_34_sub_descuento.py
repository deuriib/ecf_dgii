...
from ..models.ecf_34_tipo_descuento_recargo_type import Ecf34TipoDescuentoRecargoType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Ecf34SubDescuento")


@_attrs_define
class Ecf34SubDescuento:
    """
    Attributes:
        tipo_sub_descuento (Ecf34TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_descuento = Ecf34TipoDescuentoRecargoType(d.pop("tipoSubDescuento"))
        ...
        ecf_34_sub_descuento.additional_properties = d
        return ecf_34_sub_descuento
