...
if TYPE_CHECKING:
    from ..models.ecf_33_impuesto_adicional_otra_moneda import Ecf33ImpuestoAdicionalOtraMoneda


T = TypeVar("T", bound="Ecf33OtraMoneda")
...
class Ecf33OtraMoneda:
    ...
    Attributes:
        ...
        impuestos_adicionales_otra_moneda (list[Ecf33ImpuestoAdicionalOtraMoneda] | None | Unset):
    ...
    impuestos_adicionales_otra_moneda: list[Ecf33ImpuestoAdicionalOtraMoneda] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_impuestos_adicionales_otra_moneda(
            data: object,
        ) -> list[Ecf33ImpuestoAdicionalOtraMoneda] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for impuestos_adicionales_otra_moneda_type_1_item_data in _impuestos_adicionales_otra_moneda_type_1:
                    impuestos_adicionales_otra_moneda_type_1_item = Ecf33ImpuestoAdicionalOtraMoneda.from_dict(
                ...
                pass
            return cast(list[Ecf33ImpuestoAdicionalOtraMoneda] | None | Unset, data)
        ...
        ecf_33_otra_moneda.additional_properties = d
        return ecf_33_otra_moneda
