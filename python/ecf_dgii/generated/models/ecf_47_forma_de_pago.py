...
from ..models.ecf_47_forma_pago_type import Ecf47FormaPagoType

T = TypeVar("T", bound="Ecf47FormaDePago")
...
class Ecf47FormaDePago:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        forma_pago = Ecf47FormaPagoType(d.pop("formaPago"))
        ...
        ecf_47_forma_de_pago = cls(
            forma_pago=forma_pago,
            monto_pago=monto_pago,
        )

        ecf_47_forma_de_pago.additional_properties = d
        return ecf_47_forma_de_pago
