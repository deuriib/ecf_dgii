...
from ..models.ecf_46_tipo_descuento_recargo_type import Ecf46TipoDescuentoRecargoType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Ecf46SubDescuento")
...
class Ecf46SubDescuento:
    """
    Attributes:
        tipo_sub_descuento (Ecf46TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_descuento = Ecf46TipoDescuentoRecargoType(d.pop("tipoSubDescuento"))
        ...
        ecf_46_sub_descuento.additional_properties = d
        return ecf_46_sub_descuento
