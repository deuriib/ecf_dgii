...
from ..models.ecf_45_tipo_ingresos_validation_type import Ecf45TipoIngresosValidationType
from ..models.ecf_45_tipo_pago_type import Ecf45TipoPagoType
...
if TYPE_CHECKING:
    from ..models.ecf_45_forma_de_pago import Ecf45FormaDePago


T = TypeVar("T", bound="Ecf45IdDoc")
...
class Ecf45IdDoc:
    ...
    Attributes:
        ...
        encf (str):
        tipo_ingresos (Ecf45TipoIngresosValidationType):
        tipo_pago (Ecf45TipoPagoType):
        ...
        tabla_formas_pago (list[Ecf45FormaDePago] | None | Unset):
    ...
    tabla_formas_pago: list[Ecf45FormaDePago] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tipo_ingresos = Ecf45TipoIngresosValidationType(d.pop("tipoIngresos"))

        tipo_pago = Ecf45TipoPagoType(d.pop("tipoPago"))
        ...
        def _parse_tabla_formas_pago(data: object) -> list[Ecf45FormaDePago] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tabla_formas_pago_type_1_item_data in _tabla_formas_pago_type_1:
                    tabla_formas_pago_type_1_item = Ecf45FormaDePago.from_dict(tabla_formas_pago_type_1_item_data)
                ...
                pass
            return cast(list[Ecf45FormaDePago] | None | Unset, data)
        ...
        ecf_45_id_doc.additional_properties = d
        return ecf_45_id_doc
