...
T = TypeVar("T", bound="Ecf46SubRecargo")
...
class Ecf46SubRecargo:
    """
    Attributes:
        tipo_sub_recargo (Ecf46TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_recargo = Ecf46TipoDescuentoRecargoType(d.pop("tipoSubRecargo"))
