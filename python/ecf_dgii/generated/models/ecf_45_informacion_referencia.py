...
T = TypeVar("T", bound="Ecf45InformacionReferencia")
...
class Ecf45InformacionReferencia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_45_informacion_referencia = cls(
        ...
        ecf_45_informacion_referencia.additional_properties = d
        return ecf_45_informacion_referencia
