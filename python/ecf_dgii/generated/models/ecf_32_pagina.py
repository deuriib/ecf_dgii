...
if TYPE_CHECKING:
    from ..models.ecf_32_subtotal_impuesto_adicional import Ecf32SubtotalImpuestoAdicional


T = TypeVar("T", bound="Ecf32Pagina")
...
class Ecf32Pagina:
    ...
    Attributes:
        ...
        subtotal_impuesto_adicional (Ecf32SubtotalImpuestoAdicional | None | Unset):
    ...
    subtotal_impuesto_adicional: Ecf32SubtotalImpuestoAdicional | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.subtotal_impuesto_adicional, Ecf32SubtotalImpuestoAdicional):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subtotal_impuesto_adicional(data: object) -> Ecf32SubtotalImpuestoAdicional | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                subtotal_impuesto_adicional_type_1 = Ecf32SubtotalImpuestoAdicional.from_dict(data)

                return subtotal_impuesto_adicional_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf32SubtotalImpuestoAdicional | None | Unset, data)
        ...
        ecf_32_pagina.additional_properties = d
        return ecf_32_pagina
