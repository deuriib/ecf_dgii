...
from ..models.ecf_33_tipo_descuento_recargo_type import Ecf33TipoDescuentoRecargoType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Ecf33SubDescuento")
...
class Ecf33SubDescuento:
    """
    Attributes:
        tipo_sub_descuento (Ecf33TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_descuento = Ecf33TipoDescuentoRecargoType(d.pop("tipoSubDescuento"))
        ...
        ecf_33_sub_descuento.additional_properties = d
        return ecf_33_sub_descuento
