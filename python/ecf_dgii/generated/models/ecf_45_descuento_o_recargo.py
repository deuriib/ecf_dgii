...
from ..models.ecf_45_tipo_ajuste_type import Ecf45TipoAjusteType
...
T = TypeVar("T", bound="Ecf45DescuentoORecargo")
...
class Ecf45DescuentoORecargo:
    ...
    Attributes:
        ...
        tipo_ajuste (Ecf45TipoAjusteType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tipo_ajuste = Ecf45TipoAjusteType(d.pop("tipoAjuste"))
        ...
        ecf_45_descuento_o_recargo = cls(
        ...
        ecf_45_descuento_o_recargo.additional_properties = d
        return ecf_45_descuento_o_recargo
