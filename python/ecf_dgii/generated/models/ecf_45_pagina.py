...
if TYPE_CHECKING:
    from ..models.ecf_45_subtotal_impuesto_adicional import Ecf45SubtotalImpuestoAdicional


T = TypeVar("T", bound="Ecf45Pagina")
...
class Ecf45Pagina:
    ...
    Attributes:
        ...
        subtotal_impuesto_adicional (Ecf45SubtotalImpuestoAdicional | None | Unset):
    ...
    subtotal_impuesto_adicional: Ecf45SubtotalImpuestoAdicional | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.subtotal_impuesto_adicional, Ecf45SubtotalImpuestoAdicional):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subtotal_monto_gravado_1_pagina = _parse_subtotal_monto_gravado_1_pagina(
            d.pop("subtotalMontoGravado1Pagina", UNSET)
        )
        ...
        subtotal_monto_gravado_2_pagina = _parse_subtotal_monto_gravado_2_pagina(
            d.pop("subtotalMontoGravado2Pagina", UNSET)
        )
        ...
        subtotal_impuesto_adicional_pagina = _parse_subtotal_impuesto_adicional_pagina(
            d.pop("subtotalImpuestoAdicionalPagina", UNSET)
        )

        def _parse_subtotal_impuesto_adicional(data: object) -> Ecf45SubtotalImpuestoAdicional | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                subtotal_impuesto_adicional_type_1 = Ecf45SubtotalImpuestoAdicional.from_dict(data)

                return subtotal_impuesto_adicional_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf45SubtotalImpuestoAdicional | None | Unset, data)
        ...
        ecf_45_pagina.additional_properties = d
        return ecf_45_pagina
