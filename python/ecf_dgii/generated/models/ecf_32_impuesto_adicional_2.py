...
T = TypeVar("T", bound="Ecf32ImpuestoAdicional2")
...
class Ecf32ImpuestoAdicional2:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_impuesto = Ecf32CodificacionTipoImpuestosType(d.pop("tipoImpuesto"))
        ...
        ecf_32_impuesto_adicional_2 = cls(
        ...
        ecf_32_impuesto_adicional_2.additional_properties = d
        return ecf_32_impuesto_adicional_2
