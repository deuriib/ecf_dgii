...
if TYPE_CHECKING:
    from ..models.ecf_45_impuesto_adicional_2 import Ecf45ImpuestoAdicional2


T = TypeVar("T", bound="Ecf45Totales")
...
class Ecf45Totales:
    ...
    Attributes:
        ...
        impuestos_adicionales (list[Ecf45ImpuestoAdicional2] | None | Unset):
    ...
    impuestos_adicionales: list[Ecf45ImpuestoAdicional2] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_impuestos_adicionales(data: object) -> list[Ecf45ImpuestoAdicional2] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for impuestos_adicionales_type_1_item_data in _impuestos_adicionales_type_1:
                    impuestos_adicionales_type_1_item = Ecf45ImpuestoAdicional2.from_dict(
                ...
                pass
            return cast(list[Ecf45ImpuestoAdicional2] | None | Unset, data)
        ...
        ecf_45_totales.additional_properties = d
        return ecf_45_totales
