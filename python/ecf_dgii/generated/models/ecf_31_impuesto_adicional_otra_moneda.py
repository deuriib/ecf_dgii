...
T = TypeVar("T", bound="Ecf31ImpuestoAdicionalOtraMoneda")
...
class Ecf31ImpuestoAdicionalOtraMoneda:
    """
    Attributes:
        tipo_impuesto_otra_moneda (Ecf31CodificacionTipoImpuestosType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_impuesto_otra_moneda = Ecf31CodificacionTipoImpuestosType(d.pop("tipoImpuestoOtraMoneda"))
        ...
        ecf_31_impuesto_adicional_otra_moneda = cls(
        ...
        ecf_31_impuesto_adicional_otra_moneda.additional_properties = d
        return ecf_31_impuesto_adicional_otra_moneda
