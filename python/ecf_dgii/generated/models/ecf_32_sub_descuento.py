...
from ..models.ecf_32_tipo_descuento_recargo_type import Ecf32TipoDescuentoRecargoType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Ecf32SubDescuento")
...
class Ecf32SubDescuento:
    """
    Attributes:
        tipo_sub_descuento (Ecf32TipoDescuentoRecargoType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tipo_sub_descuento = Ecf32TipoDescuentoRecargoType(d.pop("tipoSubDescuento"))
        ...
        ecf_32_sub_descuento.additional_properties = d
        return ecf_32_sub_descuento
