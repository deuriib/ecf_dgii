...
if TYPE_CHECKING:
    from ..models.ecf_31_descuento_o_recargo import Ecf31DescuentoORecargo
    from ..models.ecf_31_encabezado import Ecf31Encabezado
    from ..models.ecf_31_informacion_referencia import Ecf31InformacionReferencia
    from ..models.ecf_31_item import Ecf31Item
    from ..models.ecf_31_pagina import Ecf31Pagina
    from ..models.ecf_31_subtotal import Ecf31Subtotal


T = TypeVar("T", bound="Ecf31ECF")
...
class Ecf31ECF:
    ...
    Attributes:
        ...
        detalles_items (list[Ecf31Item]):
        subtotales (list[Ecf31Subtotal] | None | Unset):
        descuentos_o_recargos (list[Ecf31DescuentoORecargo] | None | Unset):
        paginacion (list[Ecf31Pagina] | None | Unset):
        informacion_referencia (Ecf31InformacionReferencia | None | Unset):
    """

    encabezado: Ecf31Encabezado
    detalles_items: list[Ecf31Item]
    subtotales: list[Ecf31Subtotal] | None | Unset = UNSET
    descuentos_o_recargos: list[Ecf31DescuentoORecargo] | None | Unset = UNSET
    paginacion: list[Ecf31Pagina] | None | Unset = UNSET
    informacion_referencia: Ecf31InformacionReferencia | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.informacion_referencia, Ecf31InformacionReferencia):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        encabezado = Ecf31Encabezado.from_dict(d.pop("encabezado"))

        detalles_items = []
        _detalles_items = d.pop("detallesItems")
        for detalles_items_item_data in _detalles_items:
            detalles_items_item = Ecf31Item.from_dict(detalles_items_item_data)

            detalles_items.append(detalles_items_item)

        def _parse_subtotales(data: object) -> list[Ecf31Subtotal] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for subtotales_type_1_item_data in _subtotales_type_1:
                    subtotales_type_1_item = Ecf31Subtotal.from_dict(subtotales_type_1_item_data)
                ...
                pass
            return cast(list[Ecf31Subtotal] | None | Unset, data)

        subtotales = _parse_subtotales(d.pop("subtotales", UNSET))

        def _parse_descuentos_o_recargos(data: object) -> list[Ecf31DescuentoORecargo] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for descuentos_o_recargos_type_1_item_data in _descuentos_o_recargos_type_1:
                    descuentos_o_recargos_type_1_item = Ecf31DescuentoORecargo.from_dict(
                ...
                pass
            return cast(list[Ecf31DescuentoORecargo] | None | Unset, data)

        descuentos_o_recargos = _parse_descuentos_o_recargos(d.pop("descuentosORecargos", UNSET))

        def _parse_paginacion(data: object) -> list[Ecf31Pagina] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for paginacion_type_1_item_data in _paginacion_type_1:
                    paginacion_type_1_item = Ecf31Pagina.from_dict(paginacion_type_1_item_data)
                ...
                pass
            return cast(list[Ecf31Pagina] | None | Unset, data)

        paginacion = _parse_paginacion(d.pop("paginacion", UNSET))

        def _parse_informacion_referencia(data: object) -> Ecf31InformacionReferencia | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                informacion_referencia_type_1 = Ecf31InformacionReferencia.from_dict(data)

                return informacion_referencia_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Ecf31InformacionReferencia | None | Unset, data)
        ...
        ecf_31ecf.additional_properties = d
        return ecf_31ecf
