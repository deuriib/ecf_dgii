...
T = TypeVar("T", bound="Ecf46InformacionReferencia")
...
class Ecf46InformacionReferencia:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ecf_46_informacion_referencia = cls(
        ...
        ecf_46_informacion_referencia.additional_properties = d
        return ecf_46_informacion_referencia
