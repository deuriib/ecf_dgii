...
async def test_client_renamed_methods():
    ...
    with patch("ecf_dgii.generated.api.company.get_current_certificate.asyncio_detailed", return_value=mock_resp) as m1, \
         patch("ecf_dgii.generated.api.company.update_certificate_company.asyncio_detailed", return_value=mock_resp) as m2, \
         patch("ecf_dgii.generated.api.recepcion.get_ecf_receptor_by_message_id.asyncio_detailed", return_value=mock_resp) as m3, \
         patch("ecf_dgii.generated.api.recepcion.send_aprobacion_comercial.asyncio_detailed", return_value=mock_resp) as m4, \
         patch("ecf_dgii.generated.api.dgii.consulta_directorio_listado.asyncio_detailed", return_value=mock_resp) as m5, \
         patch("ecf_dgii.generated.api.dgii.estatus_servicios_obtener_estatus.asyncio_detailed", return_value=mock_resp) as m6, \
        ...
        await client.aprobacion_comercial("11111111-1111-1111-1111-111111111111", SendAcecfRequest(estado_type=EcfEstadoType1.ACEPTADO))
